...
class Sandipan_Testimonialmanager_Block_Adminhtml_Testimonialmanager_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function __construct()
    {
        ...
        $this->_updateButton('save', 'label', Mage::helper('testimonialmanager')->__('Save contact'));
        $this->_updateButton('delete', 'label', Mage::helper('testimonialmanager')->__('Delete contact'));
    ...
    public function getHeaderText()
    {
        if( Mage::registry('testimonialmanager') && Mage::registry('testimonialmanager')->getId() ) {
            return Mage::helper('testimonialmanager')->__('Edit Contact');
        } else {
            return Mage::helper('testimonialmanager')->__('Add contact');
        }
    }
}
