...
//        ));
        ...
        $this->addColumn('testimonial_order', array(
            'header'    => Mage::helper('testimonialmanager')->__('Order'),
            'align'     => 'left',
			'width'     => '200px',
            'index'     => 'testimonial_order',
        ));
         $this->addColumn('testimonia_subject', array(
            'header'    => Mage::helper('testimonialmanager')->__('Subject'),
            'align'     => 'left',
			'width'     => '200px',
            'index'     => 'testimonia_subject',
        ));
         $this->addColumn('testimonial_website', array(
            'header'    => Mage::helper('testimonialmanager')->__('website'),
            'align'     => 'left',
			'width'     => '200px',
            'index'     => 'testimonial_website',
        ));
 ...
 $this->addColumn('testimonial_img', array(
            'header'    => Mage::helper('testimonialmanager')->__('image'),
            'align'     => 'left',
			'width'     => '200px',
            'index'     => 'testimonial_img',
            "renderer" =>'Sandipan_Testimonialmanager_Block_Adminhtml_Renderer_Image',
        ));
 $this->addColumn('testimonial_img2', array(
            'header'    => Mage::helper('testimonialmanager')->__('image'),
            'align'     => 'left',
			'width'     => '200px',
            'index'     => 'testimonial_img2',
      "renderer" =>'Sandipan_Testimonialmanager_Block_Adminhtml_Renderer_Image',
        ));
...
//      ));
        ...
        $this->addColumn('action',
            array(
                ...
                'actions'   => array(
                    array(
                        'caption'   => Mage::helper('testimonialmanager')->__('view'),
                        'url'       => array('base'=> '*/*/edit'),
                        'field'     => 'id'
                    )
                ),
