...
class Sandipan_Testimonialmanager_Block_Adminhtml_Testimonialmanager_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('testimonial_form', array(
            'legend'	  => Mage::helper('testimonialmanager')->__('Contact Us '),
            )
        );
        ...
        $fieldset->addField('testimonial_order', 'text', array(
            'name'      => 'testimonial_order',
            'label'     => Mage::helper('testimonialmanager')->__('Order'),
        ));
        ...
        $fieldset->addField('testimonial_img', 'image', array(
         ...
         $fieldset->addField('testimonial_img2', 'image', array(
            'name'      => 'testimonial_img2',
            'label'     => Mage::helper('testimonialmanager')->__('Image2'),
        ));
        ...
        $fieldset->addField('testimonia_subject', 'text', array(
            'name'      => 'testimonia_subject',
            'label'     => Mage::helper('testimonialmanager')->__('Subject'),
        ));
