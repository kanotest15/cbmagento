...
var twitterListener = setInterval(function(){
  if(jQuery(".popupid"+popupId+".dialogBg").is(":visible")){
...
function showCoupon(action){
  ...
  mb_popups[popupId].completedAction = 1; //1=goal completed,2=popup closed,3=window closed or refreshed
  var couponAction = jQuery("#coupon-form").attr('action');
  var couponData = jQuery("#coupon-form").serialize()+"&popupId="+popupId;   
